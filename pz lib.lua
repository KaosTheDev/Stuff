...
function library:Introduction()
    ...
    xsxLogo.Image = "https://tr.rbxcdn.com/35d4c5dd0ba4a5f67dec812dea94ebe8/420/420/Decal/Png"
    ...
    hashLogo.Image = "https://tr.rbxcdn.com/35d4c5dd0ba4a5f67dec812dea94ebe8/420/420/Decal/Png"
...
function library:Init(key)
    ...
    function TabLibrary:NewTab(title)
        ...
        page.BottomImage = "https://tr.rbxcdn.com/35d4c5dd0ba4a5f67dec812dea94ebe8/420/420/Decal/Png"
        page.MidImage = "https://tr.rbxcdn.com/35d4c5dd0ba4a5f67dec812dea94ebe8/420/420/Decal/Png"
        page.ScrollBarThickness = 1
        page.TopImage = "https://tr.rbxcdn.com/35d4c5dd0ba4a5f67dec812dea94ebe8/420/420/Decal/Png"
        ...
        tabButton.MouseButton1Click:Connect(function()
            ...
            TweenService:Create(tabButton, TweenTable["tab_text_colour"], {TextColor3 = Color3.fromRGB(255,0,0)}):Play()
        end)
        ...
        function Components:NewButton(text, callback)
            ...
            button.MouseButton1Down:Connect(function()
                TweenService:Create(buttonLabel, TweenTable["hover"], {TextColor3 = Color3.fromRGB(255,0,0)}):Play()
            end)
        ...
        function Components:NewToggle(text, default, callback)
            ...
            toggleDesignGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(255, 0, 0)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(190, 0, 0))}
        ...
        function Components:NewTextbox(text, default, place, format, type, autoexec, autoclear, callback)
            ...
            if type == "small" then
                ...
                textBoxValues.Focused:Connect(function()
                    textBoxValues:GetPropertyChangedSignal("Text"):Connect(ResizeTextBox)
                    TweenService:Create(textbox, TweenTable["TextBox"], {BackgroundColor3 = Color3.fromRGB(255,0,0)}):Play()
                end)
        ...
        function Components:NewSelector(text, default, list, callback)
            ...
            for i,v in next, list do
                ...
                optionButton.MouseButton1Click:Connect(function()
                    ...
                    TweenService:Create(optionButton, TweenTable["selector"], {TextColor3 = Color3.fromRGB(255,0,0)}):Play()
        ...
        function Components:NewSlider(text, suffix, compare, compareSign, values, callback)
            ...
            sliderIndicatorGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(255,0,0)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(128, 94, 208))}
